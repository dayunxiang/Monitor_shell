$(function () {
    $(".mchart").click(function () {
        ...
        //开关量的标签id要特殊处理
        //标签id结构为：组织机构>RelatedTags>BoolSignal
        ...
        window.open(url, "WindowChart", "width=1040,height=600,toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no");
    })
})
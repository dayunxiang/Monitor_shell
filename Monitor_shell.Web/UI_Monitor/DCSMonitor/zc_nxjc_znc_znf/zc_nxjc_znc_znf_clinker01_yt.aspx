...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/DCS/zc_nxjc_znc_znf/zc_nxjc_znc_znf_clinker01_yt.jpg'); width: 1675px; height: 915px; overflow: hidden;">
         <div id="ConnectionGround" style="width: 1675px; height: 915px;margin: 0px auto; position:absolute;z-index:5555;overflow: auto;background-color:gray;opacity:0.6">
   </div>
   <div id="TextGround"style="font-size:large;padding-left:1024px;padding-bottom:200px;padding-right:500px;padding-top:0px;width:1557px;height: 807px;"></div>   
        <div id="Picture"style="position: absolute; top: 4px; left: 1000px; height: 20px; width: 20px; background-size:100% auto"></div> 
        <%--ģ����--%>
        ...
        <div class="AnlogSignal mchart" id="zc_nxjc_znc_znf>dcs01_AI116001>DCS" data-option="Alarm='HH,H,LL,L',Range='Max,Min'" style="display: block; top: 0px; left: 0px; position: absolute;color:#4cff00; text-align: center; height: 25px; right: 1675px;"></div>
       ...
       <div class="BoolSignal mchart" id="zc_nxjc_znc_znf>dcs01_BF01E406MSA>BoolSignal" style="position: absolute; top: 567px; left: 76px; height: 20px; width: 20px;" data-option="RelatedTags='dcs01_BF01A406MRD,dcs01_BF01A406MRN,0',Display='000:grayC,001:redCB,010:greenC,011:redCB,100:yellowC,101:redC,110:greenC,111:redC'"></div>
        ...
        <%--������--%>
        <div id="zc_nxjc_znc_znf>dcs01_BY113701>DCS" class="TextDisplay" style="position: absolute; top: 622px; left: 1068px; color: red; font-size: 12px; text-align: center; height: 14px; width: 119px;">���»�����</div>
        <div id="zc_nxjc_znc_znf>dcs01_BY113702>DCS" class="TextDisplay" style="position: absolute; top: 714px; left: 1246px; color: red; font-size: 12px; text-align: center; height: 14px; width: 119px;">���Ͽⶥ����</div>

...
<%--            <tr>
   ...
   <!--水泵2运行-->
    ...
    <!--均化库袋收控制箱-->
    <div class="imageContainer equipmentInfo" data-equipmentid="homogenizationDustCollectors" id="zc_nxjc_qtx_efc_clinker03>homogenizationDustCollectors>RunningState" style="position: absolute; height: 20px; width: 19px; top: 472px; left: 913px;"></div>
    <!--均化库收尘风机-->

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zc_nxjc_tsc_tsf_clinke01_shu.aspx.cs" Inherits="Monitor_tsc.web.UI_Monitor.ProcessEnergyMonitor.zc_nxjc_tsc_tsf.zc_nxjc_tsc_tsf_clinke01_shu" %>
...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/zc_nxjc_tsc_tsf_clinker01_shu.png'); width: 1350px; height: 740px; overflow: hidden;">
        ...
        <table class="mytable" style="position: absolute; top: 34px; left: 512px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalPileReclaimer>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalPileReclaimer>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalPileReclaimer>Power" class="mchart"></span></td>
            </tr>
        </table>
        <%--原煤破碎电机--%>
        <table class="mytable" style="position: absolute; top: 32px; left: 581px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalCrusher>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalCrusher>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalCrusher>Power" class="mchart"></span></td>
            </tr>
        </table>
        <%--除铁器421.01--%>
        <table class="mytable" style="position: absolute; top: 29px; left: 862px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>additionIronMachine>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>additionIronMachine>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>additionIronMachine>Power" class="mchart"></span></td>
            </tr>
        </table>
        <%--收尘器421.10--%>
        <table class="mytable" style="position: absolute; top: 29px; left: 793px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>dustCollector10>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>dustCollector10>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>dustCollector10>Power" class="mchart"></span></td>
            </tr>
        </table>
        <%--煤皮带421.02--%>
        <table class="mytable" style="position: absolute; top: 28px; left: 930px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalBelt02>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalBelt02>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalBelt02>Power" class="mchart"></span></td>
            </tr>
        </table>
        <%--煤皮带421.05--%>
        <table class="mytable" style="position: absolute; top: 179px; left: 683px;">
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalBelt05>ElectricityConsumption" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalBelt05>Current" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_tsc_tsf_clinker01>coalBelt05>Power" class="mchart"></span></td>
            </tr>
        </table>
           <%--篦冷机风机330.03--%>
